...
macro(_qt5_component_names_to_target_link_libaries output_list)
  foreach(module ${ARGN})
    _qt4or5_component_name_to_qt_component(qt_component ${module})
    list(APPEND ${output_list} Qt${QT_VERSION}::${qt_component})
    unset(qt_component)
  endforeach()
...
if (${QT_VERSION} STREQUAL "5" OR ${QT_VERSION} STREQUAL "6")
  ...
  if (NOT Qt4or5_FIND_QUIETLY)
    message(STATUS "Using ${QT_VERSION} (min: ${Qt4or5_MIN_VERSION})")
  endif()
  ...
  foreach(component Core Gui Widgets Quick1 Quick2 Test OpenGL)
    ...
    set(Qt4or5_${component}_PKGCONFIG_DEP "Qt${QT_VERSION}${qt_component}")
    unset(qt_component)
  endforeach()
...
function(qt4or5_use_modules _target _link_type)
  ...
  if ((${QT_VERSION} STREQUAL "5" AND Qt5Core_FOUND) OR (${QT_VERSION} STREQUAL "6" AND Qt6Core_FOUND))
...
macro(qt4or5_wrap_ui)
    if (${QT_VERSION} STREQUAL "5" AND Qt5Core_FOUND)
        qt5_wrap_ui(${ARGV})
    elseif (${QT_VERSION} STREQUAL "6" AND Qt6Core_FOUND)
        qt6_wrap_ui(${ARGV})
    elseif (${QT_VERSION} STREQUAL "4")
        qt4_wrap_ui(${ARGV})
    endif()
